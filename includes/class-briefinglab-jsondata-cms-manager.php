 ...
 * @since 1.0.0
 */
class Briefinglab_JsonData_CMS_Manager {
    ...
    public function __construct() {
        ...
        $this->plugin_slug = 'briefinglab-jsondata-cms';
        $this->version = '1.0.0';
        $this->options = get_option( 'briefinglab-jsondata-cms-options' );
    ...
    private function load_dependencies() {
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-briefinglab-jsondata-cms-config.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-briefinglab-jsondata-cms-model.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-briefinglab-jsondata-cms-manager-admin.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-briefinglab-jsondata-cms-manager-options.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-briefinglab-jsondata-cms-manager-public.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-briefinglab-jsondata-cms-theme-functions.php';

        require_once plugin_dir_path( __FILE__ ) . 'class-briefinglab-jsondata-cms-loader.php';
        $this->loader = new Briefinglab_JsonData_CMS_Loader();
    ...
    private function define_admin_hooks() {
        ...
        $data_model = Briefinglab_JsonData_CMS_Model::getInstance();
        $admin = new Briefinglab_JsonData_CMS_Manager_Admin( $this->version, $this->options, $data_model);
        $admin_options = new Briefinglab_JsonData_CMS_Manager_Options( $this->version, $this->options );
    ...
    private function define_public_hooks() {
        ...
        $data_model = Briefinglab_JsonData_CMS_Model::getInstance();
        $public = new Briefinglab_JsonData_CMS_Manager_Public( $this->version, $this->options, $data_model);

        Briefinglab_JsonData_CMS_Theme_Functions::define_theme_functions();
